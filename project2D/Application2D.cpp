...
bool Application2D::startup()
{
	...
	Player1.m_playerPosition = Vector2(m_shipTexture->getWidth() / 2, m_shipTexture->getHeight() / 2);
...
void Application2D::draw()
{
	...
	else
	{
		...
		if (m_lose == true)
		{
			...
			m_2dRenderer->drawText(m_font, lost, 600, 200, 1);
		}
		else
		{
			char won[20];
			sprintf_s(won, 20, "You Won");
			m_2dRenderer->drawText(m_font, won, 600, 200, 1);
		}
	}
